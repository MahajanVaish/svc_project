            ...
            <div class="col-md-11 col-lg-10 m-auto">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ $inquiry->status_name == 'joined' ? route('hydra.joined') : route('hydra.pending') }}"
                        ...
                        <div class="accordion-content">
                            ...
                            <div class="pro_filed">
                                <div class="form">
                                    ...
                                    <input type="number" id="age" name="age" value="{{ old('age', $inquiry->age) }}"
                            ...
                            <div class="pro_filed">
                                <div class="form">
                                    ...
                                    <input type="date" id="inquiry_date" name="inquiry_date"
                                        value="{{ old('inquiry_date', $inquiry->inquiry_date ? $inquiry->inquiry_date->format('Y-m-d') : date('Y-m-d')) }}"
                                        required>
                                </div>
                                <div class="form">
